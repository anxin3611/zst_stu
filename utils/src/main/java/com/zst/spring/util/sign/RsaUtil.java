...
public class RsaUtil {
    ...
    public static void plantWide(SignEnum signEnum) throws Exception {
        ...
        // 2. 签名
        byte[] sign = sign(STR_MSG, (RSAPrivateKey) keyPair.getPrivate(), signEnum);
     ...
     */
    public static byte[] sign(String data, RSAPrivateKey rsaPrivateKey, SignEnum signEnum) throws Exception {
